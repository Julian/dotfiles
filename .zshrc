...
then
    ...
    export PATH=/usr/local/share/python:/usr/local/share/python3:/usr/local/share/pypy:/usr/local/share/npm/bin:/usr/local/Cellar/ruby/1.9.3-p0/bin:/Developer/usr/bin:$(/usr/local/bin/brew --prefix coreutils)/libexec/gnubin:$PATH:/usr/local/sbin
